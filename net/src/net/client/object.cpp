...
alda::net::client::object::object(alda::net::parameters const &_parameters)
    : impl_(fcppt::make_unique_ptr<alda::net::client::detail::object_impl>(_parameters))
{
}

alda::net::client::object::~object() = default;
...
{
  return impl_->send_buffer();
}

void alda::net::client::object::queue_send() { impl_->queue_send(); }

fcppt::signal::auto_connection
alda::net::client::object::register_connect(alda::net::client::connect_callback &&_callback)
{
  return impl_->register_connect(std::move(_callback));
}

fcppt::signal::auto_connection
alda::net::client::object::register_error(alda::net::client::error_callback &&_callback)
{
  return impl_->register_error(std::move(_callback));
}

fcppt::signal::auto_connection
alda::net::client::object::register_data(alda::net::client::data_callback &&_callback)
{
