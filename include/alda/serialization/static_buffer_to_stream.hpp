...
inline void static_buffer_to_stream(
    alda::serialization::ostream &_stream, alda::raw::static_buffer<Type> const &_buffer)
{
  _stream.write(
      fcppt::cast::to_char_ptr<alda::serialization::ostream::char_type const *>(_buffer.data()),
      fcppt::cast::size<std::streamsize>(
          fcppt::cast::to_signed(fcppt::array::size<alda::raw::static_buffer<Type>>::value)));
}
