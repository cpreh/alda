...
#define ALDA_SERIALIZATION_DECLARE_MESSAGE(type_enum, message_type) \
  extern template class ALDA_DETAIL_EXPORT_EXTERNAL_CLASS_INSTANTIATION \
      alda::serialization::detail::dispatch::concrete<type_enum, message_type>; \
\
  extern template class ALDA_DETAIL_EXPORT_EXTERNAL_CLASS_INSTANTIATION \
      alda::serialization::detail::dispatch::register_<type_enum, message_type>; \
\
  extern template ALDA_DETAIL_EXPORT_EXTERNAL_FUNCTION_INSTANTIATION \
      alda::serialization::detail::read<type_enum>::message_unique_ptr \
