...
alda::call::detail::concrete<TypeEnum, Callee, Message>::concrete() : base_type()
{
}
...
{
template <typename TypeEnum, typename Callee, typename Message>
concrete<TypeEnum, Callee, Message>::~concrete() = default;
}

template <typename TypeEnum, typename Callee, typename Message>
typename Callee::result_type alda::call::detail::concrete<TypeEnum, Callee, Message>::call(
    Callee &_callee, message_type const &_message) const
{
  return _callee(
      fcppt::cast::static_downcast<alda::message::concrete<TypeEnum, Message> const &>(_message)
          .value());
}
